      ...
      <div className='max-w-full bg-custom-gradient-form h-[516px] flex items-center justify-center'>
        <div className="bg-white h-80 rounded-md">
          <div className="pt-8 ps-5 pe-5">
            ...
            <div className="pt-3"><input className="font-serif pe-40 ps-1 pt-1 pb-1 border border-gray-300 outline-none rounded-md" type="email" placeholder="Email address" /></div>
            <div className="pt-5"><input className="font-serif pe-40 ps-1 pt-1 pb-1 border border-gray-300 outline-none rounded-md" type="password" placeholder="Password" /></div>
